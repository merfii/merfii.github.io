...
function example_forestFire() {
	...
	world.registerCellType('tree', {
		...
		process: function (neighbors) {
			...
			this.sound = (this.old != this.alive);
		},
		reset: function () {
...
function example_maze() {
	...
	world.registerCellType('living', {
		...
		process: function (neighbors) {
			...
			if(surrounding === 2 && neighbors[world.BOTTOM.index] && neighbors[world.BOTTOM.index].alive){
				this.alive = false;
			}

			if(surrounding === 2 && neighbors[world.RIGHT.index] && neighbors[world.RIGHT.index].alive){
				this.alive = false;
			}
			this.sound = (this.old != this.alive);
		},
